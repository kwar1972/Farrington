...
<div class="container">
    <div class="sec_middle_title">
        ...
        <h2><span class="g-color-primary">Consulting Services</span> for all types of investors.</h2>
      ...
      <div class="media">
          <div class="media-body">
              ...
              <div class="contact_d">
                  ...
                  <a href="mailto:support@steinergreves.com?subject= Contact from from website">support@steinergreves.com</a>
              </div>
          </div>
      </div>
  </div>
                ...
                <div id="accordion-07" class="u-accordion" role="tablist" aria-multiselectable="true">
                    ...
                    <div class="card rounded-0 g-brd-none">
                      <div id="accordion-07-heading-01" class="u-accordion__header g-pa-0 g-bg-primary" role="tab">
                        <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700 g-pa-20a mb-0">
                          <a class="d-flex g-color-main g-text-underline--none--hover" href="#accordion-07-body-01" data-toggle="collapse" data-parent="#accordion-07" aria-expanded="true" aria-controls="accordion-07-body-01">
                            <span class="u-accordion__control-icon g-brd-right g-brd-black g-color-black text-center g-pa-20">
                              <i class="fa fa-plus"></i>
                              <i class="fa fa-minus"></i>
                            </span>
                            <span class="g-pa-20 g-color-black">
                              MARKET GROWTH
                            </span>
                          </a>
                        </h5>
                      ...
                      <div id="accordion-07-body-01" class="collapse show" role="tabpanel" aria-labelledby="accordion-07-heading-01" data-parent="#accordion-07">
                        <div class="g-bg-black-opacity-0_9 g-color-white g-px-50 g-py-30 text-justify">
                    ...
                    <!-- Card -->
                    <div class="card rounded-0 g-brd-none">
                      <div id="accordion-07-heading-02" class="u-accordion__header g-pa-0 g-bg-primary" role="tab">
                        <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700 g-pa-20a mb-0">
                    ...
                    <!-- Card -->
                    <div class="card rounded-0 g-brd-none">
                      <div id="accordion-07-heading-03" class="u-accordion__header g-pa-0 g-bg-primary" role="tab">
                        <h5 class="mb-0 text-uppercase g-font-size-default g-font-weight-700 g-pa-20a mb-0">
