          ...
          <div class="js-slide">
            ...
            <figure class="row">
              <div class="col-sm-6 order-sm-2">
                ...
                <p class="text-justify">Hi I am Sandra and head of operations and due diligence at <span class="g-color-primary">Steiner Greves</span>. I have broad-based experience in many aspects of international financial services, with many years in management transactions implementation and business development. My experience in transaction execution consists of conducting all due diligence and risk assessments on target acquisitions, as well as negotiating legal contracts. In business development I have revamped many departments providing them with key tools to boost efficiency within various banks and financial services companies (Deloitte Consulting, Toyo Trust, Daiwa Securities, Nedbank and KBL) to meet strategic objectives.
          ...
          <div class="js-slide">
                ...
                <figure class="row">
                  <div class="col-sm-6 order-sm-2">
                    ...
                    <p class="text-justify">Hi my name is Diana Jones and I am Head of Legal, Risk and Compliance, I have extensive experience in legal, compliance and product development for alternative asset managers as well as legal and structuring expertise for derivative products in investment banking. I have held various senior legal positions with such firms as EIM, UBP, Credit Suisse and Morgan Stanley. I am also a qualified English solicitor with a Master of Law from the University of Des Sciences Sociales in Toulouse.
