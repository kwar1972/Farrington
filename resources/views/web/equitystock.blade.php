...
<div class="container-fluid g-pt-120 g-pb-60">
    ...
    <div class="row g-mb-60">
        <header class="text-center g-width-60x--md mx-auto g-mb-20">
          <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
            <h2 class="h3 u-heading-v2__title g-color-gray-dark-v2 text-uppercase g-font-weight-600 text-uppercase">Equities <span class="g-color-primary">at a glance</span></h2>
          </div>
        </header>
      ...
      <div class="col-sm-4">
        <ul>
          <li>Trade in 16 Stock exchanges around the globe.</li>
          <li>An extensive range of financial markets within your reach.</li>
          <li>Stretch the risk across an extensive range of locations and markets.</li>
          <li>In equities you are likely to get much better returns, more than you would when
           investing in cash deposits or bonds.</li>
        </ul>
      </div>
      <div class="col-sm-2"></div>
  </div>
  <div class="row g-mb-60">
      <header class="text-center g-width-60x--md mx-auto g-mb-20">
        <div class="u-heading-v2-3--bottom g-brd-primary g-mb-20">
          <h2 class="h3 u-heading-v2__title g-color-gray-dark-v2 text-uppercase g-font-weight-600 text-uppercase">What is <span class="g-color-primary">equity investment?</span></h2>
        </div>
      </header>
    <div class="col-sm-2"></div>
    <div class="col-sm-4">
    ...
    <div class="col-sm-4">
      ...
      <p class="text-justify g-pr-40">You buy your equity shares and receive returns in the form of a dividend which the
          ...
          trading as a large portion of their wealth management strategy and, if you choose to
          increase your wealth across the world, equity trading via a wealth management firm is
          one way of doing this.</p>
    </div>
    <div class="col-sm-2"></div>
  </div>
  <div class="row">
