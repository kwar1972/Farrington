              ...
              <div class="col-sm-6 col-lg-6">
                  <div class="alert g-bg-color-darkblue g-color-white" role="alert">
                    <div class="row">
                      ...
                      <div class="col-sm-11">
                        <div class="row" style="font-size: 18px; font-weight: normal;">Welcome client area!</div>
                  ...
                  <div class="panel panel-primary">
                      <div class="panel-heading  ">
                          <h3 class="panel-title g-color-black">Client Login</h3>
                        </div>
                          ...
                          <!-- Form -->
                            <form class="g-py-15" action="{{ route('login') }}" method="post">
                                ...
                                <div class="pb-5 pl-5 pr-5">
                                  ...
                                  <div class="pl-30 pr-5 text-centered">
