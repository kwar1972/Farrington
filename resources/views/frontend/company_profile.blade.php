...
<!-- Mirrored from baxtergrant.com/company_profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2019 17:00:30 GMT -->
...
div.tp-parallax-wrap
{
 ...
 <!--================Header Area =================-->
        ...
        <!--================Banner Area =================-->
        <section class="banner_area_profile">
            <div class="container">
        ...
        <section class="business_box_area">
            <div class="container">
                <div class="sec_middle_title">
                    ...
                    <h2><span>Consulting Services</span> for all types of investors.</h2>
                    <P style="font-size:17px">Our aim is to bring our investors and management together as one, to get the best results and best return on all investment. Also to provide a better understanding of market growth and sector trends.</p>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="business_box_item">
                            ...
                            <div class="business_text">
                                ...
                                <h5>Our team of fund managers are waiting to assist you.</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="business_box_item">
                            ...
                            <div class="business_text">
                                ...
                                <h5>We offer a bespoke portfolio management service.</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="business_box_item">
                            ...
                            <div class="business_text">
                                ...
                                <h5>We are proactive in analyzing potential threats.</h5>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="company1">
                                        <h4 class="panel-title">
                                            ...
                                            <i class="fa fa-plus" aria-hidden="true"></i><i class="fa fa-minus" aria-hidden="true"></i>MARKET GROWTH
                                            </a>
                                        </h4>
                                    </div>
                                    <div id="company_c1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="company1">
                                        <div class="panel-body">
                                        A rise in interest for a particular product or service over a period of time. Market growth can be delayed if buyers do not adopt a high demand or find a product or service practical for their price level. <br><br>For example, a current technology might only be marketable to a limited set of buyers, however if the price of the technology reduces and its benefits in every day life increase, more buyers could strengthen demand. Our expert analyst are continually watching the movement of a stock and can almost determine when a particular product will hit its bottom or hit its high.
                                        </div>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="company2">
                                        <h4 class="panel-title">
                                            ...
                                            <i class="fa fa-plus" aria-hidden="true"></i><i class="fa fa-minus" aria-hidden="true"></i>GETTING THE BEST RETURNS
                                            </a>
                                        </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="company3">
                                        <h4 class="panel-title">
                                            ...
                                            <i class="fa fa-plus" aria-hidden="true"></i><i class="fa fa-minus" aria-hidden="true"></i>BUY & BUILD STRATEGY
                                            </a>
                                        </h4>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="company4">
                                        <h4 class="panel-title">
                                            ...
                                            <i class="fa fa-plus" aria-hidden="true"></i><i class="fa fa-minus" aria-hidden="true"></i>INVESTMENT EXPERIENCE
                                            </a>
                                        </h4>
                                    </div>
...
<!-- Mirrored from baxtergrant.com/company_profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Sep 2019 17:00:49 GMT -->
</html>